...
export default function App() {
  ...
  async function handleSubmit() {
    ...
    const response = await ask({
      ...
      systemPrompt: "You are a helpful TAU support assistant.",
    });
  ...
  return (
    <PageLayout
      ...
      toolDescription="AI-powered support assistant for TAU staff and students"
      toolNameHe="תמיכת אוניברסיטת תל אביב"
      toolDescriptionHe="עוזר תמיכה מבוסס בינה מלאכותית לסגל ולסטודנטים באוניברסיטת תל אביב"
    >
